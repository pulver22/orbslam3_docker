...
docker exec -it orbslam3 bash -i -c  "git clone -b add_euroc_example.sh https://github.com/pulver22/ORB_SLAM3.git /ORB_SLAM3 && cd /ORB_SLAM3 && chmod +x build.sh && ./build.sh "
